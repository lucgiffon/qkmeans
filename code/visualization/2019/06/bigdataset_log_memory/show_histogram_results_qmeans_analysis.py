...
if __name__ == "__main__":
    suf_path = "2019/06/qmeans_analysis_bigdataset_log_memory"
        ...
        for hierarchical_value in hierarchical_values:
            ...
            for str_task in tasks:
                ...
                for idx_sparsy_val, sparsy_val in enumerate(sparsity_values):
                    ...
                    try:
                        ...
                        if "empty dataframe" in str(e):
                            logger.warning("{} for sparsy val {}".format(str(e), sparsy_val))
                        else:
                            raise e
                    ...
                    try:
                        ...
                        if len(df_sparsy_val_kmeans_palm) == 0:
                            raise Exception("empty dataframe")
                ...
                try:
                    ...
                    if "empty dataframe" in str(e):
                        logger.warning("{} for kmeans".format(str(e)))
                    else:
                        raise e
