...
if __name__ == "__main__":
    input_dir = "/home/luc/PycharmProjects/qalm_qmeans/results/2019/06/qmeans_analysis_littledataset_fast_precompute_centroids_norm/qmeans_analysis_littledataset_fast_1_node"
    output_dir = "/home/luc/PycharmProjects/qalm_qmeans/reports/figures/2019/06/qmeans_analysis_littledataset_fast_precompute_centroids_norm/qmeans_analysis_littledataset_fast_1_node/histogrammes"
    ...
    for dataset_name in datasets:
        ...
        for hierarchical_value in [True, False]:
            ...
            for str_task in tasks:
                ...
                ax.set_ylim(top=max_value_in_plot* (1+1./6.))
