...
if __name__ == "__main__":
    ...
    output_dir = "/home/luc/PycharmProjects/qalm_qmeans/reports/figures/2019/06/qmeans_analysis_littledataset_B/histogrammes"
    output_dir = pathlib.Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)

    df_results_kmeans = get_df("/home/luc/PycharmProjects/qalm_qmeans/results/2019-05/qmeans_analysis_littledataset_3_80_ghz_cpu")
    df_results_kmeans = df_results_kmeans[df_results_kmeans["kmeans"]]
