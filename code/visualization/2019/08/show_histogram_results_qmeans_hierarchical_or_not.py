...
if __name__ == "__main__":
    ...
    suf_path = "2019/08/3_4_qmeans_analysis_blobs_hierarchical_or_not"
    input_dir = create_input_dir(suf_path)


    output_dir = "/home/luc/PycharmProjects/qalm_qmeans/reports/figures/"+ "2019/08/aaai_conference" + "hierar_or_not/histogrammes"
