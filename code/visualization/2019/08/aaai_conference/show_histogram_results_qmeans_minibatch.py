...
if __name__ == "__main__":
    ...
    suf_path = "2019/08/2_3_qmeans_minibatch"
    input_dir =  create_input_dir(suf_path)

    output_dir = "/home/luc/PycharmProjects/qalm_qmeans/reports/figures/"+ "2019/08/aaai_conference" + "/minibatch/histogrammes"
    ...
    for str_task in tasks:
        ...
        if "nystrom_sampled_error_reconstruction" in str_task:
            ...
            task_values_nystrom_uniform = [pd.to_numeric(df_dataset_kmeans[df_dataset_kmeans["--million-blobs"] == clust_nbr][str_task_special_1nn], errors="coerce") for clust_nbr in nb_million]
