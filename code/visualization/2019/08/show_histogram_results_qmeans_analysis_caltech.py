...
if __name__ == "__main__":
    ...
    suf_path = "2019/08/0_1_qmeans_objective_function_caltech50_support"
    ...
    df_results = df_results[df_results["--nb-cluster"] != 1024]
        ...
        for hierarchical_value in hierarchical_values:
            ...
            for str_task in tasks:
                ...
                if "1nn_kmean" in str_task:
                    extra_bars = 3
                elif "nystrom_sampled_error_reconstruction" in str_task or "nystrom_svm_accuracy" in str_task:
                    extra_bars = 1
                else:
                    extra_bars = 0
                ...
                if "nystrom_sampled_error_reconstruction" in str_task or "nystrom_svm_accuracy" in str_task:
