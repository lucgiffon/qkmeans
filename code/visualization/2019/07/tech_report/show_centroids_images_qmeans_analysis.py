...
def show_centroids_from_vector(arr_matrix_centroids, title, shape):
    ...
    for i in range(nb_centroids):
        ...
        ax.imshow(reconstructed_centroid, cmap='gray')
        ax.set_xticks([])
        ax.set_yticks([])
        ax.set_aspect("equal")
...
if __name__ == "__main__":
    ...
    output_dir = "/home/luc/PycharmProjects/qalm_qmeans/reports/figures/" + "2019/07/tech_report" + "/centroids"
    ...
    for dataset_name in datasets:
            ...
            for idx_sparsy_val, sparsy_val in enumerate(lst_sparsity_values):
                ...
                for idx_nb_clust, clust_nbr in enumerate(lst_nb_cluster_values):
                    ...
                    for oar_id in df_nb_clust["oar_id"]:
                        ...
                        seed_val = df_nb_clust[df_nb_clust["oar_id"] == oar_id]["--seed"][0]
                        ...
                        show_centroids_from_vector(flat_centroids, "{} Qmeans {} clusters sparsity factor {} seed {} {}{} - nb param {}".format(dataset_name,
                                                                                                                                        clust_nbr,
                                                                                                                                        sparsy_val,
                                                                                                                                        seed_val,
                                                                                                                                        oar_id.split(".")[-1],
        ...
        for idx_nb_clust, clust_nbr in enumerate(lst_nb_cluster_values):
            ...
            for oar_id in df_nb_clust["oar_id"]:
                ...
                show_centroids_from_vector(flat_centroids, "{} Kmeans {} clusters seed {}, {} - nb param {}".format(dataset_name,
                                                                                                           clust_nbr,
                                                                                                           seed_val,
                                                                                                           oar_id.split(".")[-1],
                                                                                                           nbr_param), shapes[dataset_name])
            ...
            for idx_sparsy_val, sparsy_val in enumerate(lst_sparsity_values):
                ...
                for idx_nb_clust, clust_nbr in enumerate(lst_nb_cluster_values):
                    ...
                    for oar_id in df_nb_clust["oar_id"]:
                        ...
                        seed_val = df_nb_clust[df_nb_clust["oar_id"] == oar_id]["--seed"][0]
                        title = "{} Kmeans with palm {} clusters seed {} {} sparsity factor {}{} - nbr param {}".format(dataset_name,
                                                                                                                  clust_nbr,
                                                                                                                  seed_val,
                                                                                                                  oar_id.split(".")[-1],
                                                                                                                  sparsy_val,
