...
if __name__ == "__main__":
    ...
    y_axis_label_by_task = {
        "assignation-mean-time": "temps (s)",
        "test-ami": "ami",
        "train-ami": "ami",
        "1nn-kmean-inference-time": "temps (s)",
        "nystrom-build-time": "temps (s)",
        "nystrom-inference-time": "temps (s)",
        "nystrom-sampled-error-reconstruction": "log(erreur)",
        "traintime": "temps (s)",
        "1nn-kmean-accuracy": "précision",
        "batch-assignation-mean-time": "temps (s)",
        "1nn-get-distance-time": "temps(s)",
        "nystrom-svm-accuracy": "précision",
        "nystrom-svm-time": "temps(s)",
        "nb-param": "log(# valeurs non nulles)",
    ...
    dct_name_legend = {
        "nystrom-sampled-error-reconstruction-uniform": "Echantillonage uniforme",
        "nystrom-sampled-error-reconstruction-uop": "F-Nys",
        "nystrom-sampled-error-reconstruction-uop-kmeans": "K F-Kys",
        "nystrom-svm-accuracy-uniform": "Echantillonage uniforme",
        "nystrom-svm-accuracy-uop": "F-Nys",
        "nystrom-svm-accuracy-uop-kmeans": "K F-Kys",
    }
    ...
    dct_legend_color = {
        "QK-means parcimonie 2": "dodgerblue",
        "QK-means parcimonie 3": "blue",
        "QK-means parcimonie 5": "purple",
        "Echantillonage uniforme": "gray",
        "F-Nys": "orange",
        "K F-Kys": "olive"
            ...
            for init in init_schemes:
                ...
                for hierarchical_value in [True]:
                    ...
                    for sparsity_value in sparsity_values:
                        ...
                        trace_name = "QK-means parcimonie {}".format(int(sparsity_value))
                ...
                for title_figure, fig in dct_sparsity_figure.items():
                    if "nystrom" in title_figure:
                        x_axis_title = "# Points de référence"
                    else:
                        x_axis_title = "# Groupes"
