...
Usage:
  efficient_nystrom [-h] [-v|-vv] [--seed=int] (--coil20 int|--blobs str|--light-blobs|--covtype|--breast-cancer|--census|--kddcup04|--kddcup99|--plants|--mnist|--fashion-mnist|--lfw|--caltech256 int|--million-blobs int) --nb-landmarks=int [--max-eval-train-size=init] --nystrom=int [--standardize-std]
