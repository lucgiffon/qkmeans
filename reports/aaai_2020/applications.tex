...
% 
% \begin{tabular}{ccccc}
%                                        & \multicolumn{2}{c}{\texttt{Blobs}}           & \multicolumn{2}{c}{\texttt{Caltech}} \\
%                                      K & \thead{Accuracy  } & \thead{Inference time} & \thead{Accuracy} & \thead{Accuracy} \\ 
% \midrule
%  & N/A & N/A   \\
%  & N/A & N/A   \\
%  & N/A & N/A   \\ 
% \midrule \midrule
%  128            & 0.96 & \multirow{3}{*}{0.00}     \\
%  256            & 0.97 &                                                          \\
%  512            & 0.99 &                                                          \\ 
% \midrule
%  128            & 0.98 & 0.98     \\
...
% 
% \begin{tabular}{ccc}
%                                  & \multicolumn{2}{c}{\texttt{MNIST}} \\
%                               K  & \thead{Accuracy} & \thead{Inference time}  \\ 
% \midrule
%                &  0.97  \\
%                &  0.97  \\
%                &  0.97  \\ 
...
% 
% \end{tabular}
% \caption{Classification task: results averaged over 5 runs. For \qkmeans, only results with sparsity level~5 are displayed.}
% \end{table*}
...
\multirow{2}{*}{\shortstack{1NN \\ Accuracy}}           & \kmeans               & \boldsymbol{$0.96$}                   & \boldsymbol{$0.97$}                & \boldsymbol{$0.99$}                 & \boldsymbol{$remp$}                  & \boldsymbol{$remp$}                    & $remp$                       & \boldsymbol{$0.96$}           & \boldsymbol{$0.96$}   & \boldsymbol{$0.96$}   \\
...
\end{tabular}}
\caption{
Results of numerical experiments for landmark selection methods based on either \kmeans, \qkmeans or uniform sampling: Nyström approximation error for a sample set of size $5000$; Matrix vector multiplication time averaged over $5000$ observations; 1-nearest neighbor classification accuracy on the test set; SVM classification on top of Nyström transformation on the test set. The \qkmeans results are obtained with sparse factors with at least 2 values in each line and each column. The uniform sampling based Nyström approximation running times are not displayed because they are the same as for the Nyström approximation based on \kmeans centers. Every experiment results are averaged over 5 runs. Best results are bold while second best are underlined (when there are three).}
\label{tab:nystrom}
\end{table*}
