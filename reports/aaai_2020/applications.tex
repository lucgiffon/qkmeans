...
and this advantage is even stronger with the clustering obtained by our \qkmeans method. We see that for the \texttt{Blobs} dataset, this speed-up comes at a cost as we can see a drop in classification performance but not for the other datasets. We believe our method is more sensible to the very noisy nature of the blobs dataset.
% 
% \begin{figure}[tbh]
% \centering
