...
and this advantage is even stronger with the clustering obtained by our \qkmeans method. This speed-up comes at a cost in though, as we can see a drop in classification performance. \todo[inline]{verifier avec caltech si ce ``drop'' de perf est toujours present (normalement non)}
% 
% \begin{figure}[tbh]
% \centering
...
\multirow{2}{*}{\shortstack{Inference \\ time (ms)}}    & \kmeans               & \boldsymbol{$0.11$}                   & \boldsymbol{$0.17$}                  & $0.32$                            & \boldsymbol{$0.09$}                  & \boldsymbol{$0.14$}                    & $0.21$                       & \boldsymbol{$0.06$}           & \boldsymbol{$0.06$}   & $0.07$   \\
...
\multirow{5}{*}{\shortstack{1NN \\ Accuracy}}           & \kmeans               & \boldsymbol{$0.96$}                   & \boldsymbol{$0.97$}                & \boldsymbol{$0.99$}                 & \boldsymbol{$0.11$}                  & \boldsymbol{$0.11$}                    & \boldsymbol{$0.11$}        & \underline{$0.96$}           & \underline{$0.96$}   & \underline{$0.96$}   \\
                                                        ...
                                                        & Ball-tree            &                                           \multicolumn{3}{c|}{$N/A$}                                               &                               \multicolumn{3}{c|}{$N/A$}                                                    &                    \multicolumn{3}{c}{\boldsymbol{$0.97$}}                                 \\
...
\multirow{5}{*}{\shortstack{1NN \\ Runtime (s)}} & \kmeans               & \boldsymbol{$17.2$}                   & \boldsymbol{$15.8$}                  & \boldsymbol{$9.5$}                & $74.4$                                             & $50.0$                                           & $35.3$                       & \boldsymbol{$0.74$}           & \boldsymbol{$0.83$}   & \boldsymbol{$0.88$}   \\
                                                        & \qkmeans              & $5.3$                                & \boldsymbol{$3.0$}                 & \boldsymbol{$1.2$}             & \boldsymbol{$67.0$}                               & \boldsymbol{$30.9$}                              & \boldsymbol{$19.8$}            & \underline{$0.73$}           & \underline{$0.79$}   & \underline{$0.86$}   \\
                                                        & Brute force          &                                           \multicolumn{3}{c|}{$N/A$}                                          &                               \multicolumn{3}{c|}{$N/A$}                                                    &                    \multicolumn{3}{c}{$2176.1$}                                 \\
                                                        & Ball-tree            &                                           \multicolumn{3}{c|}{$N/A$}                                          &                               \multicolumn{3}{c|}{$N/A$}                                                    &                    \multicolumn{3}{c}{$553.0$}                                 \\
