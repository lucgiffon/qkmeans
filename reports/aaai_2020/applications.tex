...
\multirow{2}{*}{\shortstack{Number of \\parameters}}    & \kmeans               & $256,000$                   & $512,000$                  & $1,024,000$                     & \boldsymbol{$remp$}                  & \boldsymbol{$remp$}                    & $remp$                       & $7,840$           & $12,544$   & $25,088$   \\
                                                        & \qkmeans              & $\boldsymbol{6,207}$        & \boldsymbol{$8,656$}                 & \boldsymbol{$14,078$}                     & $remp$                               & $remp$          & \boldsymbol{$remp$}            & $\boldsymbol{2,610}$    & \boldsymbol{$2,269$}       & \boldsymbol{$2,427$}    \\                                                        
