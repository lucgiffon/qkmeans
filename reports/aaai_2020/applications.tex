...
\end{subtable}
\end{adjustbox}
\caption{Classification task: results averaged over 5 runs. For \qkmeans, only results with sparsity level~5 are displayed. ``N/A'' denotes experiments that did not finish. }
\end{table*}
...
\todo[inline]{Dans le caption de Table 2, préciser pour quoi  certaines expériences n'ont pas terminé (out of xxx time limit).}
