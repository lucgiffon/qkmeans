...
ascertained, the authors of \cite{bolte2014proximal} derived an algorithm called \textit{Hierarchical PALM4LED} that is able to find good local minima and that has
a version that is provably convergent.
