...
\todo[inline]{Ajouter les résultats Nyström + SVM aux jeux de données MNIST et Fashion Mnist}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=.49\textwidth]{blobs_nystrom_error.png}
\includegraphics[width=.49\textwidth]{blobs_nystrom_inference_time.png}
