...
Previous attempts to alleviate the computational issues in K-means often relied on batch-, sparsity- and randomization-based methods~\cite{Sculley2010Web, boutsidis2014randomized,shen2017compressed,liu2017sparse}. \addLG{Nous n'avons pas encore d'expés qui montre un gain de complexité à ce niveau et je doute qu'on y arrive...}
