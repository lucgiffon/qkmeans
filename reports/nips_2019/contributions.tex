...
\begin{itemize}
 ...
 \item \addLG{$\rmD_{\sqrt{\rvn}} (\rmU - \rmV)$ is an extension of $\sqrt{n_k}\left (\rvu_k-\rvv_k\right )$ in matrix form such that $\left[\rmD_{\sqrt{\rvn}} (\rmU - \rmV) \right ]_k = \sqrt{n_k}\left (\rvu_k-\rvv_k\right )$;}
