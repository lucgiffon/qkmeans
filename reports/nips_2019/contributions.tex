...
\subsection{Convergence of QK-means}
...
\begin{algorithm}[t]
	...
	\begin{algorithmic}[1]
		...
		\hfill \COMMENT{$\mathcal{O}\left (\nexamples\left(A\log A+B\right )+A^2\log A+AB\right )$}
...
%		\label{line:qmeans:endkmeans}
		...
		\hfill \COMMENT{$\mathcal{O}\left (\text{TODO from palm4msa}\right )$}
...
\addVE{TODO: fix how to write indicator function instead of $\mathbf{1}_{\mathcal{E}_q}(\rmS_q)$ in algo QK-means.}
